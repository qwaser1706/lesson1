...
b.endswith(c)  #  проверка на окончание строки или слова
zip() # сложение нескольких списков 
max()#выдача маклимального элемента
min()#выдача минимального элемента
round(___, 2) # округление до двух знаков после запятой
=  # приравнивание
